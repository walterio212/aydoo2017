...
public class IntegracionTest {
	...
	@Test
	public void obtenerReporteDeAhorrosDeberiaDevolverLasVentasDeLosClienteEnUnMes(){
		...
		List<ReporteDeAhorros> reporteDeAhorros = club.obtenerReportesDeAhorro(Month.FEBRUARY);
		
		Assert.assertEquals(2, reporteDeAhorros.size());
		Assert.assertEquals(clienteA, reporteDeAhorros.get(0).obtenerCliente());
		Assert.assertEquals(1, reporteDeAhorros.get(0).obtenerVentas().size());
		Assert.assertEquals(clienteB, reporteDeAhorros.get(1).obtenerCliente());
		Assert.assertEquals(2, reporteDeAhorros.get(1).obtenerVentas().size());
	}
}
